#!/usr/bin/env python
# This code is for Python3.  It was written by www.continualintegration.com.  It was adapted from 
# the launcher.py file from https://repo1.maven.org/maven2/com/facebook/presto/presto-server/0.149/presto-server-0.149.tar.gz
# This was tested to work with Presto version 0.149.  It may or may not work with different versions.
...
class Process:
    def __init__(self, path):
        ...
        self.path = path
        self.pid_file = open_read_write(path, 0o0600)
        self.refresh()
...
def open_append(f):
    ...
    return os.open(f, O_WRONLY | O_APPEND | O_CREAT, 0o0644)
